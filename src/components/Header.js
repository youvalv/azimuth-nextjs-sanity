                ...
                <div className="inner">
                    <div className="site-header-inside">
                        <div className="site-branding">
                            ...
                            {((_.get(page, '_type') === 'landing') || (_.get(page, '_type') === 'blog')) ?
                                <h1 className="site-title"><Link href={safePrefix('/')}>{_.get(config, 'header.title')}</Link></h1>
                                :
                                <p className="site-title"><Link href={safePrefix('/')}>{_.get(config, 'header.title')}</Link></p>
                            }
                        </div>
