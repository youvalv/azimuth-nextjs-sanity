        ...
        return (
            <footer id="colophon" className="site-footer">
                    ...
                    <div className="inner">
                        <div className="footer-widgets">
                            <div className="widget footer-branding">
                                {_.get(this.props, 'config.footer.logo_img') ?
                                    <p className="site-logo">
                                        <Link href={safePrefix('/')}><img src={_.get(this.props, 'config.footer.logo_img.asset.url')} alt="Logo" /></Link>
                                    </p>
                                    :
                                    <p className="site-title">
                                        <Link href={safePrefix('/')}>{_.get(this.props, 'config.header.title')}</Link>
                                    </p>
                                }
                                {_.get(this.props, 'config.footer.tagline') &&
                                ...
                                <div className="footer-nav-inside">
                                    ...
                                    <div className="secondary-nav">
                                        ...
                                        <ul className="secondary-menu">
                                            {_.map(_.get(this.props, 'config.footer.nav_links'), (action, actionIdx) => (
                                                <li key={actionIdx}>
                                    ...
                                    <div className="social-nav">
                                        <h2 className="widget-title">{_.get(this.props, 'config.footer.social_title')}</h2>
                            ...
                            <div className="widget footer-subscribe">
                                <h2 className="widget-title">{_.get(this.props, 'config.footer.subscribe_title')}</h2>
                                {_.get(this.props, 'config.footer.subscribe_content') &&
                                <p>{htmlToReact(_.get(this.props, 'config.footer.subscribe_content'))}</p>
                                }
                ...
                <div className="site-info outer">
                    <div className="inner">
                        {htmlToReact(_.get(this.props, 'config.footer.content'))}
                        &nbsp;
                        {_.map(_.get(this.props, 'config.footer.links'), (link, linkIdx) => (
